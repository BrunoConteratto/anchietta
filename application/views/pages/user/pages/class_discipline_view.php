		<div class="row breadcrumb user-breadcrumb">
	        <ul>
	            ...
	            <li><i class="fa fa-angle-right breadcrumb-icon-space"></i> Turma <i class="fa fa-angle-right breadcrumb-icon-space"></i> Minhas disciplinas.</li>
	        </ul>
		</div>
		<br>
		...
		<div class="row user-panel">
			...
			<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8">
				<div class="row btn-group gallery-year" role="group">
					<button type="button" class="btn btn-Dark" onclick="searchDisciplines(-1);"><strong>-</strong></button>
